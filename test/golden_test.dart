...
void main() {
  test('golden test for completion script', () {
    final script = generateCompletionScript(['my_app']);
    ...
    expect(script, contains('###-for-zsh-###'));
    expect(script, contains('compdef __my_app_completion my_app'));
  ...
  test('generate script for specific shell', () {
    final script = generateCompletionScript(['my_app'], shells: {Shell.fish});
